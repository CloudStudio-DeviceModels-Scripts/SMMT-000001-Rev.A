...
# Parsing + Configuration Script – SMMT-000001 - Rev. A

This **Parsing + Configuration** script is designed for the **SMMT-000001** model in **Gear Studio**, part of the [Cloud Studio](https://www.cloud.studio/) platform.
...
# Script de Parsing + Configuration – SMMT-000001 Rev. A

Este script de **Parsing + Configuration** está diseñado para el modelo **SMMT-000001** en **Gear Studio**, parte de la plataforma [Cloud Studio](https://www.cloud.studio/).
